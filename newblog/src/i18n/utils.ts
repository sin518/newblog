 ...
 *
 * Routing rules:
 *  - The configured default locale serves at the URL root with NO prefix.
 ...
 * Anything starting with a non-default locale prefix resolves to that locale; otherwise
 ...
 * (e.g. '/posts/welcome' for both ZH and EN). Pass `availableLocales` to
